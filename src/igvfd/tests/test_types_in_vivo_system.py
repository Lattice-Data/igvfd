...
def test_in_vivo_system_create_with_intended_cell_types(testapp, other_lab, human_donor,
...
def test_in_vivo_system_intended_cell_types_min_items(testapp, other_lab, human_donor,
...
def test_in_vivo_system_intended_cell_types_unique_items(testapp, other_lab, human_donor,
                                                         controlled_term_brain, controlled_term):
    testapp.post_json(
        '/in_vivo_system',
        {
...
def test_in_vivo_system_intended_cell_types_linkto_validation(testapp, other_lab, human_donor,
                                                              controlled_term_brain):
    testapp.post_json(
        '/in_vivo_system',
        {
