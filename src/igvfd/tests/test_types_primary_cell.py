...
def test_primary_cell_summary_with_description(testapp, primary_cell_with_description):
    res = testapp.get(primary_cell_with_description['@id'])
    assert res.json.get('summary') == 'Test primary cell sample'


def test_primary_cell_summary_with_uuid(testapp, primary_cell):
    res = testapp.get(primary_cell['@id'])
    uuid = res.json.get('uuid')
    assert res.json.get('summary') == uuid


def test_primary_cell_required_fields(testapp, other_lab, human_donor, controlled_term_brain):
    # Missing lab
    testapp.post_json(
        '/primary_cell',
        {
...
def test_primary_cell_passage_number_minimum(testapp, other_lab, human_donor, controlled_term_brain):
    testapp.post_json(
        '/primary_cell',
        {
            'lab': other_lab['@id'],
...
def test_primary_cell_date_obtained_format(testapp, other_lab, human_donor, controlled_term_brain):
    # Invalid date format
    testapp.post_json(
        '/primary_cell',
        {
...
def test_primary_cell_create_success(testapp, other_lab, human_donor, controlled_term_brain):
    item = {
        'lab': other_lab['@id'],
        'donors': [human_donor['@id']],
        'sample_terms': [controlled_term_brain['@id']],
    ...
    res = testapp.post_json('/primary_cell', item, status=201)
...
def test_primary_cell_create_with_passage_number(testapp, other_lab, human_donor, controlled_term_brain):
    item = {
        'lab': other_lab['@id'],
        'donors': [human_donor['@id']],
        'sample_terms': [controlled_term_brain['@id']],
...
def test_primary_cell_create_with_all_optional_fields(testapp, other_lab, human_donor, controlled_term_brain):
    item = {
        'lab': other_lab['@id'],
        'donors': [human_donor['@id']],
        'sample_terms': [controlled_term_brain['@id']],
...
def test_primary_cell_passage_number_zero(testapp, other_lab, human_donor, controlled_term_brain):
